...
const VapiControls = ({ book }: { book: IBook }) => {
    ...
    return (
        <>
            <div className="max-w-4xl mx-auto flex flex-col gap-8 text-white">
                {/* Header Card */}
                <div className="vapi-header-card">
                    <div className="vapi-cover-wrapper">
                        <Image
                            ...
                            width={120}
                            height={180}
                            className="vapi-cover-image !w-[120px] !h-auto border border-white/20"
                            priority
                        />
                        <div className="vapi-mic-wrapper relative">
                            {isActive && (status === 'speaking' || status === 'thinking') && (
                                <div className="absolute inset-0 rounded-full bg-white/35 animate-ping opacity-75" />
                            )}
                            <button
                            ...
                            >
                                {isActive ? (
                                    ...
                                    <MicOff className="size-7 text-white/90" />
                                )}
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 flex-1">
                        <div>
                            ...
                            <p className="text-slate-300 font-medium">by {book.author}</p>
                        </div>
